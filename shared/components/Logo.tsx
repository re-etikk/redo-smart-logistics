export default function Logo({ compact }: { compact?: boolean }) {
  return (
    <span className="inline-flex items-center gap-2.5 select-none">
      {/* Brand mark: exact black R with yellow accent slash */}
      <svg width="36" height="36" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path d="M6 36 L18 8 H28 C34 8 38 12 36 18 C34 23 29 25 24 25 L32 36 H24 L17 25 H14 L9 36 H6 Z" fill="#0F172A" />
      ...
      {!compact && (
        <span className="leading-none">
          ...
          <span className="block text-[9px] font-extrabold text-slate-500 tracking-wider uppercase mt-0.5">
            Transport &amp; Logistics
          </span>
        </span>
      )}

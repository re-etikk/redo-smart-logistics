  ...
  const submit = async (e: FormEvent) => {
    ...
    try {
      ...
      const localProfile = {
        ...
        role: "truck_owner",
        full_name: email.split("@")[0] || "Truck Owner",
        company_name: "REDO Fleet Logistics",
        phone: email.replace(/[^0-9]/g, "") || "+91 9811234567",
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF9] text-slate-900 font-sans selection:bg-amber-400 flex flex-col justify-between">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-12 w-full grid lg:grid-cols-12 gap-8 items-center flex-1">
        ...
        {/* Left Side: Value Props & Truck Visual */}
        <div className="lg:col-span-6 space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-100/80 border border-amber-300 text-amber-900 text-[11px] font-bold">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-slate-950">
              Welcome Back, <br />
              <span className="text-[#FBBF24]">Truck Owner!</span>
            </h1>
            <p className="text-xs sm:text-sm text-slate-600 font-medium max-w-md">
              Log in to manage your fleet, find profitable loads and grow your business with REDO.
            </p>
          </div>
          ...
          <div className="space-y-3.5 max-w-md">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-xs text-slate-900">Find More Loads</h4>
                <p className="text-[11px] text-slate-500 font-medium">Get matched with high-paying loads instantly.</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center font-black shrink-0">
                <IndianRupee size={16} />
              </div>
              <div>
                <h4 className="font-black text-xs text-slate-900">Track Earnings</h4>
                <p className="text-[11px] text-slate-500 font-medium">View earnings and payments in real-time.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-xs text-slate-900">Manage Fleet</h4>
                <p className="text-[11px] text-slate-500 font-medium">Manage your trucks, drivers and documents easily.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-xs text-slate-900">Fast Payments</h4>
                <p className="text-[11px] text-slate-500 font-medium">Get paid directly in your bank, quickly and securely.</p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-2 max-w-sm">
            <img
              src="/assets/owner_auth_truck.png"
              alt="REDO Container Truck"
              className="w-full h-auto rounded-2xl drop-shadow-md object-contain"
            />
          </div>
        </div>
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Enter the email or phone linked to your REDO Truck Owner account, and we will send you instructions to reset your password.
                  </p>
                </div>

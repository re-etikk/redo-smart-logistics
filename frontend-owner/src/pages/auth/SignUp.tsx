...
import { Eye, EyeOff, Lock, Mail, Truck, IndianRupee, Users, ArrowRight, ArrowLeft, User, AlertCircle } from "lucide-react";
        ...
        <div className="lg:col-span-6 flex justify-center lg:justify-end">
          <div className="bg-white border border-slate-200/80 rounded-3xl p-7 sm:p-9 shadow-xl max-w-md w-full space-y-6">
            ...
            <form onSubmit={submit} className="space-y-3.5 text-xs font-bold">
              <div>
                <label className="text-[10px] uppercase text-slate-400 block mb-1">Full Name / Transporter Name</label>

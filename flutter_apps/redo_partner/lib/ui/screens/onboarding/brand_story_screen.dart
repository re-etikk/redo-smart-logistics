...
class PartnerBrandStoryScreen extends StatefulWidget {
  final VoidCallback onComplete;
  const PartnerBrandStoryScreen({super.key, required this.onComplete});

  @override
  State<PartnerBrandStoryScreen> createState() => _PartnerBrandStoryScreenState();
}

class _PartnerBrandStoryScreenState extends State<PartnerBrandStoryScreen> with TickerProviderStateMixin {
  ...
  Future<void> _finishIntro() async {
    ...
    await prefs.setBool('has_seen_partner_brand_story_v1', true);
    widget.onComplete();
  }
  ...
  String _getStepTitle(int step) {
    switch (step) {
      case 0:
        return '1. Fleet Network';
      case 1:
        return '2. Partner Reveal';
      case 2:
        return '3. Connecting Highways';
      case 3:
        return '4. Zero Empty Miles';
      case 4:
        return '5. National Corridors';
      case 5:
        return '6. Partner Perks';
      case 6:
        return '7. Trucking Simple';
      case 7:
        return '8. Readying Console...';
      case 8:
        return '9. Start Earning';
      default:
        return '';
    }
  }
  ...
  Widget _buildStep2LogoReveal() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Fleet & Commercial Driver Console',
          style: GoogleFonts.inter(
            fontSize: 13,
  ...
  Widget _buildStep3TaglineMap() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Connecting Every Truck\nTo High-Paying Corridors',
          textAlign: TextAlign.center,
          style: GoogleFonts.inter(
            fontSize: 18,
            fontWeight: FontWeight.w900,
        ...
        Container(
          width: 50,
          height: 3,
          decoration: BoxDecoration(color: AppColors.brandYellow, borderRadius: BorderRadius.circular(2)),
        ),
        const Spacer(),
        _buildBottomHint(),
      ],
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureRow(
            ...
            desc: 'Direct shipper-to-truck corridor matches with 0% broker fee',
          ),
          const SizedBox(height: 16),
          _buildFeatureRow(
            icon: Icons.account_balance_wallet_outlined,
            title: 'Fast & Guaranteed Payouts',
            desc: 'Instant settlement upon digital POD signature confirmation',
          ),
          const SizedBox(height: 16),
          _buildFeatureRow(
            icon: Icons.verified_user_outlined,
            title: 'Verified Corporate Shippers',
            desc: '100% GST compliant enterprise cargo and secure freight',
          ),
          const SizedBox(height: 40),
          Text(
            'Built for Bharat\'s\nHardworking Fleet Owners',
            textAlign: TextAlign.center,
            style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.slateDark),
          ),
          const SizedBox(height: 8),
          Container(
            width: 40,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w800, color: AppColors.slateDark)),
                const SizedBox(height: 2),
                Text(desc, style: GoogleFonts.inter(fontSize: 12, color: AppColors.inkMuted)),
              ],
            ),
          ),
        ],
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.slateDark),
        ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Welcome to',
            style: GoogleFonts.caveat(fontSize: 32, fontWeight: FontWeight.w700, color: AppColors.slateDark),
          ),
          const SizedBox(height: 10),
          Container(
            width: 80,
          ...
          Text(
            'redo Partner',
            style: GoogleFonts.inter(fontSize: 34, fontWeight: FontWeight.w900, color: AppColors.slateDark, letterSpacing: -0.5),
          ),
          Text(
            'Fleet & Logistics',
            style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.inkMuted, letterSpacing: 1.2),
          ),
          const SizedBox(height: 36),
          SizedBox(
            width: double.infinity,

...
class _KycVerificationScreenState extends State<KycVerificationScreen> {
  ...
  static const String _prefKeyKyc = 'redo_partner_kyc_data_v1';
  static const String _prefKeyStatus = 'redo_partner_kyc_status_v1';
    ...
    if (savedJson != null) {
      try {
        ...
        setState(() {
          ...
          _gstinOrDlCtrl.text = data['gstin_dl'] ?? '';
  ...
  Future<void> _submitVerification() async {
    if (!_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please fill all required verification fields correctly.'),
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('✓ Commercial KYC & Vahan Verification Approved!'),
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                'Commercial Driver Identification (Sarathi & Vahan)',
                style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w800, color: textPrimary),
              ),
              const SizedBox(height: 4),
              Text(
                'Verified drivers get 35% more trip allocations and instant FASTag advances.',
              ...
              _buildTextField(
                ...
                label: 'Driver Legal Name (as per Driving License)',
                hint: 'e.g. Ramesh Kumar Yadav',
              ...
              _buildTextField(
                controller: _panCtrl,
                label: 'PAN Card Number (for 1% TDS exemption)',
                hint: 'e.g. ABCDE1234F',
              ...
              _buildTextField(
                ...
                label: 'Operating Home Base / Permanent Address',
                hint: 'e.g. Near Toll Gate, Transport Nagar, Patna',
  ...
  Widget _buildStatusCard(bool isDark, Color cardBorder) {
    ...
    if (_verificationStatus == 'verified') {
      ...
      title = 'Sarathi & Vahan Verified';
      subtitle = 'Commercial driving permit and vehicle RC authenticated. Highest tier priority matching active.';
    } else {
      ...
      subtitle = 'Submit driving license and RC book to unlock high-tonnage interstate corridor loads.';
    }

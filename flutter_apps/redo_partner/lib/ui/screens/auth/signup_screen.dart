              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Join REDO Partner Network',
                        style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w900, color: AppColors.ink),
                      ),
                      const SizedBox(height: 6),
                      Text(
                        'Get verified return trip loads on high-traffic national corridors.',
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Driver / Truck Owner Full Name',
                          hintText: 'e.g. Harpreet Singh',

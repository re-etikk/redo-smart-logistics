...
class _DirectChatScreenState extends State<DirectChatScreen> {
  ...
  final List<String> _quickChips = [
    'Reached warehouse gate 📍',
    'Ready for loading 🚛',
    'E-Way Bill verified 📄',
    'En route on highway 🛣️',
    'Delivery completed ✅',
  ];
  ...
  String get _storageKey => 'redo_partner_chat_${widget.bookingId}';
  ...
  Future<void> _sendMessage([String? quickText]) async {
    ...
    final myId = SupabaseService.currentUser?.id ?? 'me';
    final myName = SupabaseService.currentUser?.userMetadata?['full_name'] ?? 'Driver';
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              child: Text(
                widget.counterpartyName.isNotEmpty ? widget.counterpartyName[0].toUpperCase() : 'S',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Trip #${widget.bookingId.length > 8 ? widget.bookingId.substring(0, 8).toUpperCase() : widget.bookingId} • ${widget.origin} → ${widget.destination}',
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  Text('Photo attached', style: GoogleFonts.inter(fontSize: 12, color: textPrimary)),
                  const Spacer(),
                  IconButton(
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Message customer / shipper...',
